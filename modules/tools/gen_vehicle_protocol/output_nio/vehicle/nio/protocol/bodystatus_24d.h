...
class Bodystatus24d : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Bodystatus_24d::DoorajarfrntlestsType doorajarfrntlests(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::DoorajarfrntristsType doorajarfrntrists(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::DoorajarrelestsType doorajarrelests(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int bcm_closure_crc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::SeatoccpfrntlefailType seatoccpfrntlefail(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::SteerwhlheatstsType steerwhlheatsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int bcm_closure_msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::TrajarstsType trajarsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::HoodajarstsType hoodajarsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::DoorajarreristsType doorajarrerists(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::SeatoccpfrntlestsType seatoccpfrntlests(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Bodystatus_24d::CooltlvllowwarnreqType cooltlvllowwarnreq(const std::uint8_t* bytes, const int32_t length) const;
