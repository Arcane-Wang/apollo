...
class Epsstatus02d6 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double epsestrackforce(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t eps02msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t eps02crc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double epsmotortq(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double epspinionag(const std::uint8_t* bytes, const int32_t length) const;
