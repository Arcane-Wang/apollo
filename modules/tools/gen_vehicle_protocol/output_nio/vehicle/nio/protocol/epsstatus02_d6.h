...
class Epsstatus02d6 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  ::atlas_messages::epsstatus02_d6::EPS_TqReqAvlType EPS_TqReqAvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus02_d6::EPS_PinionAngReqAvlType EPS_PinionAngReqAvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 35, 'is_signed_var': False, 'len': 10, 'name': 'EPS_EstRackForce', 'offset': -20.48, 'order': 'motorola', 'physical_range': '[-20.48|20.44]', 'physical_unit': 'KN', 'precision': 0.04, 'type': 'double'}
   EPS_EstRackForce(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus02_d6::EPS_HandsOffDetnConfidenceType EPS_HandsOffDetnConfidence(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 15, 'is_signed_var': False, 'len': 4, 'name': 'EPS_02_MsgCntr', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|15]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   EPS_02_MsgCntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus02_d6::EPS_PinionAgValidType EPS_PinionAgValid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus02_d6::EPS_DrvOverRideDetnType EPS_DrvOverRideDetn(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name': 'EPS_02_CRC', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   EPS_02_CRC(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 55, 'is_signed_var': False, 'len': 10, 'name': 'EPS_MotorTq', 'offset': -10.24, 'order': 'motorola', 'physical_range': '[-10.24|10.22]', 'physical_unit': 'Nm', 'precision': 0.02, 'type': 'double'}
   EPS_MotorTq(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus02_d6::EPS_MotorTqValidType EPS_MotorTqValid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 23, 'is_signed_var': False, 'len': 15, 'name': 'EPS_PinionAg', 'offset': -1638.4, 'order': 'motorola', 'physical_range': '[-1638.4|1638.2]', 'physical_unit': 'Deg', 'precision': 0.1, 'type': 'double'}
   EPS_PinionAg(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus02_d6::EPS_EstRackForceValidType EPS_EstRackForceValid(const std::uint8_t* bytes, const int32_t length) const;
};
