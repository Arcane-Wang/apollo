...
class Whlspdfront51 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Int32 wfmsgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Int32 wfcrc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Float64 whlspdfr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Float64 whlspdfl(const std::uint8_t* bytes, const int32_t length) const;
};
