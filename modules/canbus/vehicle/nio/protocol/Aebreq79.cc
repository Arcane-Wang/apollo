...
Aebreq79::AbareqType Aebreq79::abareq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(4, 1);

  Aebreq79::AbareqType ret =  static_cast<Aebreq79::AbareqType>(x);
  return ret;
}
...
Aebreq79::AbasnvtylvlType Aebreq79::abasnvtylvl(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(1, 2);

  Aebreq79::AbasnvtylvlType ret =  static_cast<Aebreq79::AbasnvtylvlType>(x);
  return ret;
}
...
Aebreq79::AwbsnvtylvlType Aebreq79::awbsnvtylvl(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(5, 2);

  Aebreq79::AwbsnvtylvlType ret =  static_cast<Aebreq79::AwbsnvtylvlType>(x);
  return ret;
}
...
Aebreq79::AwbreqType Aebreq79::awbreq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(6, 1);

  Aebreq79::AwbreqType ret =  static_cast<Aebreq79::AwbreqType>(x);
  return ret;
}
...
Aebreq79::ScmdecelreqType Aebreq79::scmdecelreq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(2, 1);

  Aebreq79::ScmdecelreqType ret =  static_cast<Aebreq79::ScmdecelreqType>(x);
  return ret;
}
...
Aebreq79::AebdecelreqType Aebreq79::aebdecelreq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(6, 1);

  Aebreq79::AebdecelreqType ret =  static_cast<Aebreq79::AebdecelreqType>(x);
  return ret;
}
...
Aebreq79::EbadecelreqType Aebreq79::ebadecelreq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(7, 1);

  Aebreq79::EbadecelreqType ret =  static_cast<Aebreq79::EbadecelreqType>(x);
  return ret;
}
...
Aebreq79::AbpreqType Aebreq79::abpreq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 1);

  Aebreq79::AbpreqType ret =  static_cast<Aebreq79::AbpreqType>(x);
  return ret;
}
...
Aebreq79::PedpdecreqType Aebreq79::pedpdecreq(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(4, 1);

  Aebreq79::PedpdecreqType ret =  static_cast<Aebreq79::PedpdecreqType>(x);
  return ret;
}
