...
class Motorsts0286 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int motor02_msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int motor02_crc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Motorsts_02_86::FrntmottqvalidType frntmottqvalid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Motorsts_02_86::FrntmotspdvalidType frntmotspdvalid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int frntmotspd(const std::uint8_t* bytes, const int32_t length) const;
};
