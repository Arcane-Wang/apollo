...
class Whlspdrear52 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  // config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name': 'WR_CRC', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|15]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   WR_CRC(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 15, 'is_signed_var': False, 'len': 4, 'name': 'WR_MsgCntr', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|15]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   WR_MsgCntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::whlspdrear_52::WhlspdRRstsType WhlspdRRsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::whlspdrear_52::WhlspdRRdirType WhlspdRRdir(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 31, 'is_signed_var': False, 'len': 13, 'name': 'WhlspdRR', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|360]', 'physical_unit': 'km/h', 'precision': 0.05625, 'type': 'double'}
   WhlspdRR(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::whlspdrear_52::WhlspdRLstsType WhlspdRLsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::whlspdrear_52::WhlspdRLdirType WhlspdRLdir(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 55, 'is_signed_var': False, 'len': 13, 'name': 'WhlspdRL', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|360]', 'physical_unit': 'km/h', 'precision': 0.05625, 'type': 'double'}
   WhlspdRL(const std::uint8_t* bytes, const int32_t length) const;
};
