...
class Driverstatus24e : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Driverstatus_24e::EpbstsType epbsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::VcuaccrpedlovrdType vcuaccrpedlovrd(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::Ibesp2_warningType ibesp2_warning(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::AirbwarnreqType airbwarnreq(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int driversts_msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::SeatbltmidrowristsType seatbltmidrowrists(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::SeatbltmidrowmidstsType seatbltmidrowmidsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::SeatbltfrntlestsType seatbltfrntlests(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::PassairbginhbnlampreqType passairbginhbnlampreq(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::SeatoccptfrntristsType seatoccptfrntrists(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::CrashdetdType crashdetd(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::SeatbltfrntristsType seatbltfrntrists(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int driversts_crc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Driverstatus_24e::SeatbltmidrowlestsType seatbltmidrowlests(const std::uint8_t* bytes, const int32_t length) const;
