...
class Pulsecnt65 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int32_t whlplscntrr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t whlplscntrl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t whlplscntfr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t whlplscntfl(const std::uint8_t* bytes, const int32_t length) const;
};
