...
class Scmsts7b : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  ::atlas_messages::scmsts_7b::SCMFailStsType SCMFailSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::HiLowBeamPushSwtStsType HiLowBeamPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::FrntWiprSwtStsType FrntWiprSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::TurnIndcrSwtStsType TurnIndcrSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::FogLiPushSwtStsType FogLiPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::FrntWiprInterSpdType FrntWiprInterSpd(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::MenuOrVolDwnPushSwtStsType MenuOrVolDwnPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::AccSpdIncOrResuSwtStsType AccSpdIncOrResuSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::AccTimeGapIncSwtStsType AccTimeGapIncSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::SelnPushSwtStsType SelnPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::ModeTogDecSwtStsType ModeTogDecSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::ModeTogIncSwtStsType ModeTogIncSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::MenuPushSwtStsType MenuPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::SWCFailStsType SWCFailSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::AccSpdDecSwtStsType AccSpdDecSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name': 'SCM_CRC', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   SCM_CRC(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::MenuLePushSwtStsType MenuLePushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::MenuOrVolUpPushSwtStsType MenuOrVolUpPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 15, 'is_signed_var': False, 'len': 4, 'name': 'SCM_MsgCntr', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|15]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   SCM_MsgCntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::AccTimeGapDecSwtStsType AccTimeGapDecSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::MenuRiPushSwtStsType MenuRiPushSwtSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::scmsts_7b::AccSetSwtStsType AccSetSwtSts(const std::uint8_t* bytes, const int32_t length) const;
};
