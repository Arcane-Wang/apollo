...
class Pulsecnt65 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Pulsecnt_65::WhlplscntrrvldType whlplscntrrvld(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int whlplscntrr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Pulsecnt_65::WhlplscntrlvldType whlplscntrlvld(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int whlplscntrl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Pulsecnt_65::WhlplscntfrvldType whlplscntfrvld(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int whlplscntfr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Pulsecnt_65::WhlplscntflvldType whlplscntflvld(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int whlplscntfl(const std::uint8_t* bytes, const int32_t length) const;
};
