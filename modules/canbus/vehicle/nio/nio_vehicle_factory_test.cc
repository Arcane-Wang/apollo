...
class NioVehicleFactoryTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    ...
    params_.set_brand(apollo::common::NIO);
    nio_factory_.SetVehicleParameter(params_);
  }
  virtual void TearDown() {}

 protected:
  NioVehicleFactory nio_factory_;
  CanbusConf canbus_conf_;
  VehicleParameter params_;
};

TEST_F(NioVehicleFactoryTest, Init) {
  apollo::cyber::Init("vehicle_factory_test");
  EXPECT_EQ(nio_factory_.Init(&canbus_conf_), true);
}
