...
void Motorsts0286::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_nio()->mutable_motorsts_02_86()->set_motor02_msgcntr(motor02_msgcntr(bytes, length));
  chassis->mutable_nio()->mutable_motorsts_02_86()->set_motor02_crc(motor02_crc(bytes, length));
  chassis->mutable_nio()->mutable_motorsts_02_86()->set_frntmottqvalid(frntmottqvalid(bytes, length));
  chassis->mutable_nio()->mutable_motorsts_02_86()->set_frntmottq(frntmottq(bytes, length));
  chassis->mutable_nio()->mutable_motorsts_02_86()->set_frntmotspdvalid(frntmotspdvalid(bytes, length));
  chassis->mutable_nio()->mutable_motorsts_02_86()->set_frntmotspd(frntmotspd(bytes, length));
}
...
int Motorsts0286::motor02_msgcntr(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
...
int Motorsts0286::motor02_crc(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
...
Motorsts_02_86::FrntmottqvalidType Motorsts0286::frntmottqvalid(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(7, 1);

  Motorsts_02_86::FrntmottqvalidType ret =  static_cast<Motorsts_02_86::FrntmottqvalidType>(x);
  return ret;
}
...
Motorsts_02_86::FrntmotspdvalidType Motorsts0286::frntmotspdvalid(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(3, 1);

  Motorsts_02_86::FrntmotspdvalidType ret =  static_cast<Motorsts_02_86::FrntmotspdvalidType>(x);
  return ret;
}
...
int Motorsts0286::frntmotspd(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
  int32_t x = t0.get_byte(0, 8);
