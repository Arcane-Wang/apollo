...
class Epsstatus01d5 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double steerangle(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t epsdmsgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t epsdcrc(const std::uint8_t* bytes, const int32_t length) const;
};
