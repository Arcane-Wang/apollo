...
class Epsstatus01d5 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  ::atlas_messages::epsstatus01_d5::EPSwarnLampType EPSwarnLamp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus01_d5::ABS_AgreqAvlType ABS_AgreqAvl(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 47, 'is_signed_var': False, 'len': 10, 'name': 'TorsBarTq', 'offset': -10.0, 'order': 'motorola', 'physical_range': '[-10|10]', 'physical_unit': 'Nm', 'precision': 0.02, 'type': 'double'}
   TorsBarTq(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus01_d5::EPSstsType EPSsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus01_d5::EPSModType EPSMod(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus01_d5::SteeragspddirType Steeragspddir(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 52, 'is_signed_var': False, 'len': 9, 'name': 'Steeragspd', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|2550]', 'physical_unit': 'Deg/sec', 'precision': 5.0, 'type': 'double'}
   Steeragspd(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus01_d5::Steer_angledirType Steer_angledir(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::epsstatus01_d5::Steer_angleandspdvalidType Steer_angleandspdvalid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 23, 'is_signed_var': False, 'len': 13, 'name': 'Steer_angle', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|800]', 'physical_unit': 'Deg', 'precision': 0.1, 'type': 'double'}
   Steer_angle(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 15, 'is_signed_var': False, 'len': 4, 'name': 'EPS_D_MsgCntr', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|15]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   EPS_D_MsgCntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 7, 'is_signed_var': False, 'len': 8, 'name': 'EPS_D_CRC', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|255]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   EPS_D_CRC(const std::uint8_t* bytes, const int32_t length) const;
};
