...
class Whlspdfront51 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  int wf_msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int wf_crc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Whlspdfront_51::WhlspdfrstsType whlspdfrsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Whlspdfront_51::WhlspdfrdirType whlspdfrdir(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Whlspdfront_51::WhlspdflstsType whlspdflsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Whlspdfront_51::WhlspdfldirType whlspdfldir(const std::uint8_t* bytes, const int32_t length) const;
