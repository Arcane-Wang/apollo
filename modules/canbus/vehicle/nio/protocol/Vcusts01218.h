...
class Vcusts01218 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Int32 vcuvlcsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Int32 vcullcsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Int32 taggear(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Int32 vcu17msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Int32 vcu17crc(const std::uint8_t* bytes, const int32_t length) const;
