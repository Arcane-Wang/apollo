...
class Brkdrvstatus24c : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  // config detail: {'bit': 61, 'is_signed_var': False, 'len': 4, 'name': 'Brk_Msgcntr', 'offset': 0.0, 'order': 'motorola', 'physical_range': '[0|16]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
   Brk_Msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::BrkpressureStsType BrkpressureSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 55, 'is_signed_var': False, 'len': 10, 'name': 'Brkpressure', 'offset': -30.0, 'order': 'motorola', 'physical_range': '[-30|276.6]', 'physical_unit': 'bar', 'precision': 0.3, 'type': 'double'}
   Brkpressure(const std::uint8_t* bytes, const int32_t length) const;
  ...
  // config detail: {'bit': 39, 'is_signed_var': False, 'len': 16, 'name': 'LongAccValue', 'offset': -2.0, 'order': 'motorola', 'physical_range': '[2|2]', 'physical_unit': 'g', 'precision': 0.001, 'type': 'double'}
   LongAccValue(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::VehspdstsType Vehspdsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::VehspddirType Vehspddir(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::EPBswstsType EPBswsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::Drv_stateType Drv_state(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::BrkPedlStsType BrkPedlSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::BrkListsType BrkLists(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::EPBfaillampType EPBfaillamp(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::brkdrvstatus_24c::EPBwarnlampType EPBwarnlamp(const std::uint8_t* bytes, const int32_t length) const;
};
