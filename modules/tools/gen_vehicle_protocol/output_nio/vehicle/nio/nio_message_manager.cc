...
NioMessageManager::NioMessageManager() {
  // Control Messages
  AddSendProtocolData<Accreq7f, true>();
  AddSendProtocolData<Aebreq79, true>();
  AddSendProtocolData<Avpreq15e, true>();
  AddSendProtocolData<Epsreqc6, true>();
  AddSendProtocolData<Lightreq336, true>();
