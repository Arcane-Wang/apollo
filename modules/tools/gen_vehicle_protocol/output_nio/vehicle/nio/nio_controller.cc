...
void NioController::ResetProtocol() {
...
void NioController::SecurityDogThreadFunc() {
  ...
  while (can_sender_->IsRunning()) {
    ...
    if (elapsed < default_period) {
      ...
      AERROR
          << "Too much time consumption in NioController looping process:"
          << elapsed.count();
    }
  }
}
