...
class Accreq7f : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double accmaxjerk(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double accminjerk(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double acccomforlow(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double acccomforup(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double acctara(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t accmsgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int32_t acccrc(const std::uint8_t* bytes, const int32_t length) const;
};
