...
class Vcusts01218 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Vcusts_01_218::VcunbsstsType vcunbssts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int vcu_vlcsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int vcu_llcsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vcusts_01_218::Tag_gearvalidType tag_gearvalid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int tag_gear(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vcusts_01_218::Actual_gearvalidType actual_gearvalid(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vcusts_01_218::Actual_gearType actual_gear(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int vcu_17_msgcntr(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int vcu_17_crc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vcusts_01_218::Vcu_epfailType vcu_epfail(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vcusts_01_218::VcumodindType vcumodind(const std::uint8_t* bytes, const int32_t length) const;
};
