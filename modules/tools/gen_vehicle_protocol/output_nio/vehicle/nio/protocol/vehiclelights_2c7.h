...
class Vehiclelights2c7 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  ::atlas_messages::vehiclelights_2c7::FogFrntlightStsType FogFrntlightSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::vehiclelights_2c7::LeftTurnlightstsType LeftTurnlightsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::vehiclelights_2c7::RightTurnlightstsType RightTurnlightsts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::vehiclelights_2c7::LobeamlightStsType LobeamlightSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::vehiclelights_2c7::HibeamlightStsType HibeamlightSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::vehiclelights_2c7::EmergcyLightStsType EmergcyLightSts(const std::uint8_t* bytes, const int32_t length) const;
  ...
  ::atlas_messages::vehiclelights_2c7::FrntwiperStsType FrntwiperSts(const std::uint8_t* bytes, const int32_t length) const;
};
